...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden">
      ...
      <div className={`${styles.paddingX} absolute inset-0 sm:top-[120px] xs:top-[350px] top-[75px] max-w-7x1 mx-auto flex flex-row items-start gap-5`}>
      ...
      <div className='absolute lg:left-[14vw] xs:top-10 lg:top-0  w-full flex justify-center items-center'>
        ...
        <h2 className={`${styles.heroBubbleText} absolute lg:left-[45vw] xs:left-[46vw] xs:top-[0px] lg:top-10 `}> $CLUB</h2>
        </div>
